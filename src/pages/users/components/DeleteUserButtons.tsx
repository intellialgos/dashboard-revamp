...
const DeleteUserButton = ({user, refetch}: {user: User, refetch: () => QueryActionCreatorResult<QueryDefinition<any, any, any, any, any>>}) => {
    ...
    return (
      ...
      {(user?.filter || user?.permission) && <Popconfirm
      title="Delete User"
      ...
      cancelText="No"
    >
      <Button size="small" type="primary" loading={isLoading} danger>Delete</Button>
    </Popconfirm>}
    </>
  )
}
